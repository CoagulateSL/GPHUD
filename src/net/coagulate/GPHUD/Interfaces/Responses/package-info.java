...
@Classes.Change(date="2022-04-23",
                ...
                component=Classes.COMPONENT.Protocol,
                message="Block empty messages from being sent in a JSON payload (a secondary fix for things saying 's' in blank contexts etc)")
