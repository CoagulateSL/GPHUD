...
public class Form implements Renderable {
    ...
    public Form(State st, boolean setreturnurl, String targeturl, String buttonname, String... inputs) throws SystemException {
            ...
            if ((inputs.length % 2) ==1) { throw new SystemException("Input varargs must be even (key,value pairs), we got "+inputs.length); }
    ...
    public Form add(Renderable e) { list.add(e); return this; }
