 ...
 */
@Classes.Change(component=Classes.COMPONENT.Protocol, date="2022-04-21", type=ChangeLogging.CHANGETYPE.Change, message="Re-enable purging of disconnected URLs, but only on 404/Malformed, not on all IO errors")
