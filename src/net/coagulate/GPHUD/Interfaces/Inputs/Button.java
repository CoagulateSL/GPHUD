...
public class Button extends Input {
	...
	final                                                      String name;
	@SuppressWarnings("FieldNameHidesFieldInSuperclass") final String value;
	boolean borderless;
	...
	public String asHtml(final State st,final boolean rich) {
		...
		if (borderless) {
			style=
					"-webkit-appearance: textfield; border-top-width: 1px; border-right-width: 1px; border-left-width: 1px; border-bottom-width: 1px; padding-bottom: 0px; "+
