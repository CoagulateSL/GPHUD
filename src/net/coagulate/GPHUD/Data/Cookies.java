...
public class Cookies {
    ...
    public static void refreshCookie(String cookie) {
        ...
        if (toupdate>1) { GPHUD.getLogger().warning("Unexpected anomoly, "+toupdate+" rows to update on cookie "+cookie); }
    ...
    private void validateCookie() throws SystemException {
        try { load(); }
        catch (NoDataException e) { throw new SystemException("Cookie Expired!",e); }
    ...
    public void setAvatar(Avatar avatar) {
        ...
        GPHUD.getDB().d("update cookies set avatarid=? where cookie=?",avatar.getId(),cookie); load();
    }
    ...
    public void setCharacter(Char character) {
        ...
        if (character!=null) {
            ...
            if (i!=null) { // if has instance, character should be from it...
                if (character.getInstance()!=i) { throw new UserException("Character is not from the selected instance"); }
            } else {
     ...
     */
    public void setInstance(Instance entity) { Integer id=null; if (entity!=null) { id=entity.getId(); } GPHUD.getDB().d("update cookies set instanceid=? where cookie=?",id,cookie); load(); }    
