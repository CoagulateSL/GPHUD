...
public class Objects extends TableRow {
	...
	@Nonnull
	public static Objects connect(final State st, final String uuid, final String name, @Nonnull final Region region, @Nonnull final User owner, final String location, final String url, final int version) {
