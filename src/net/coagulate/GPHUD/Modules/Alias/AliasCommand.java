...
public class AliasCommand extends Command {
    ...
    JSONObject definition; public JSONObject getDefinition() { return definition; }
    Command targetcommand; public Command getTargetCommand() { return targetcommand; }
    String name;
    String fail="";
    ...
    @Override
    public boolean permitConsole() { if (targetcommand==null) { return false; } return targetcommand.permitConsole(); }

    @Override
    public boolean permitHUDWeb() {if (targetcommand==null) { return false; } return targetcommand.permitHUDWeb(); }

    @Override
    public boolean permitJSON() { if (targetcommand==null) { return false; } return targetcommand.permitJSON(); }

    @Override
    public boolean permitUserWeb() { if (targetcommand==null) { return false; } return targetcommand.permitUserWeb(); }

    @Override
    public String getFullMethodName() { if (targetcommand==null) { return "Can not invoke - "+fail; } return this.getClass().getCanonicalName()+"("+getName()+"), will invoke "+targetcommand.getFullMethodName(); }

    @Override
    public String requiresPermission() { if (targetcommand==null) { return ""; } return targetcommand.requiresPermission(); }
