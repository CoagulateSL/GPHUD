...
public abstract class CookBook {
	protected static void charAttribute(@Nonnull final State st, final boolean act, @Nonnull final Table t, final String attribute, final String selfmodify, final String attributetype, final String grouptype, final String useabilitypoints, final String required, final String defaultvalue) {
		t.openRow();
	...
	protected static void setKV(@Nonnull final State st, final boolean act, @Nonnull final Table t, @Nonnull final TableRow object, @Nonnull final String attribute, final String newvalue) {
		t.openRow();
	...
	protected static void createAlias(@Nonnull final State st, final boolean act, @Nonnull final Table t, @Nonnull final String aliasname, final String target, @Nonnull final JSONObject template) {
		t.openRow();
	...
	protected static void menu(@Nonnull final State st, final boolean act, @Nonnull final Table t, final String label, final String command) {
