...
public abstract class HelpPage {
	...
	public static void index(@Nonnull final State st,
		...
		f.noForm();
		f.add("<table width=100% height=100%><tr width=100% height=100%><td width=100% height=100% valign=top><iframe width=100% height=100% frameborder=0 "+"src=\"https"+
				      "://coagulate.sl/Docs/GPHUD/index.php/Main_Page.html\"></iframe></td></tr></table>");
	}
