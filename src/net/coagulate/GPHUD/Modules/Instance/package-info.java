...
@KVS(name="AllowedNamingSymbols", description="What characters may be used in a character's name, A-Z, a-z space and dash (-) are assumed OK",defaultvalue="",editpermission="Instance.ConfigureCharacters",type=KVTYPE.TEXT,template=false,scope=KVSCOPE.INSTANCE)
