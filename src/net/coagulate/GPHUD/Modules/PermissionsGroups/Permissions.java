...
public abstract class Permissions {
	...
	public static Response addPermission(@Nonnull final State st,
	                                     @Nonnull @Arguments(description="Permissions group to add permission to", type=ArgumentType.PERMISSIONSGROUP) final PermissionsGroup permissionsgroup,
	...
	public static Response delPermission(@Nonnull final State st,
	                                     @Nonnull @Arguments(description="Permissions group to remove permission from", type=ArgumentType.PERMISSIONSGROUP) final PermissionsGroup permissionsgroup,
