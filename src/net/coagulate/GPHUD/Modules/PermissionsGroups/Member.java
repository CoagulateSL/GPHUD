...
public abstract class Member {
	...
	public static Response eject(@Nonnull final State st,
	                             @Nonnull @Arguments(type=ArgumentType.PERMISSIONSGROUP, description="Permissions group to remove member from") final PermissionsGroup permissionsgroup,
	                             @Nonnull @Arguments(description="Avatar to remove from the group", type=ArgumentType.AVATAR) final User avatar)
	{
	...
	public static Response invite(@Nonnull final State st,
	                              @Nonnull @Arguments(description="Permissions group to join avatar to", type=ArgumentType.PERMISSIONSGROUP) final PermissionsGroup permissionsgroup,
	                              @Nonnull @Arguments(description="Avatar to join to group", type=ArgumentType.AVATAR) final User avatar)
	{
	...
	public static void setPermissionsForm(@Nonnull final State st,
	                                      @Nonnull final SafeMap values)
	{
	...
	public static Response setPermissions(@Nonnull final State st,
	                                      @Nonnull @Arguments(type=ArgumentType.PERMISSIONSGROUP, description="Permissions group to set a users permissions in") final PermissionsGroup permissionsgroup,
	                                      @Nonnull @Arguments(type=ArgumentType.AVATAR, description="Avatar in the group to set permissions of") final User avatar,
	                                      @Arguments(type=ArgumentType.BOOLEAN, description="Can the user invite people to this group") final Boolean caninvite,
	                                      @Arguments(type=ArgumentType.BOOLEAN, description="Can the user remove people from this group") final Boolean cankick)
	{
