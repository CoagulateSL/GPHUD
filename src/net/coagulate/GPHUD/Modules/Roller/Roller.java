...
public class Roller {
	...
	public static Response rollOnly(@Nonnull final State st,
	                                @Nullable @Arguments(name="dice",description="Number of dice to roll",
	                                                     type=ArgumentType.INTEGER,
	                                                     mandatory=false) Integer dice,
	                                @Nullable @Arguments(name="sides",description="Number of sides on dice",
	                                                     type=ArgumentType.INTEGER,
	...
	public static Response roll(@Nonnull final State st,
	                            ...
	                            @Nullable @Arguments(name="sides",description="Number of sides on dice",
	                                                 type=ArgumentType.INTEGER,
	                                                 mandatory=false) Integer sides,
	                            @Nullable @Arguments(name="bias",description="Optional bias to add to result",
	                                                 mandatory=false,
	...
	public static Response rollDefault(@Nonnull final State st,
	                                   @Arguments(name="reason",description="Logged reason for the roll",
	                                              type=ArgumentType.TEXT_ONELINE,
	...
	public static Response rollAgainst(@Nonnull final State st,
	                                   @Nullable @Arguments(name="target",description="Character to roll against",
	                                   ...
	                                   @Nullable @Arguments(name="bias",description="Optional bias to add to result",
	                                                        mandatory=false,
	                                                        type=ArgumentType.INTEGER) Integer bias,
	                                   @Nullable @Arguments(name="targetdice",description="Number of dice to roll",
	                                                        type=ArgumentType.INTEGER,
	                                                        mandatory=false) Integer targetdice,
	                                   @Nullable @Arguments(name="targetsides",description="Number of sides on dice",
	                                                        type=ArgumentType.INTEGER,
	                                                        mandatory=false) Integer targetsides,
	                                   @Nullable @Arguments(name="targetbias",description="Optional bias to add to result",
	                                                        mandatory=false,
	...
	public static Response rollDamageAgainst(@Nonnull final State st,
	                                         @Nonnull @Arguments(name="target",description="Character to roll against",
	                                                             type=ArgumentType.CHARACTER_NEAR) final Char target,
	                                         @Arguments(name="dice",description="Number of dice to roll",
	                                                    type=ArgumentType.INTEGER,
	                                                    mandatory=false) final Integer dice,
	                                         @Arguments(name="sides",description="Number of sides on dice",
	                                                    type=ArgumentType.INTEGER,
	                                                    mandatory=false) final Integer sides,
	                                         @Arguments(name="bias",description="Optional bias to add to result",
	                                                    mandatory=false,
	                                                    type=ArgumentType.INTEGER) final Integer bias,
	                                         @Arguments(name="targetdice",description="Number of dice to roll",
	                                                    type=ArgumentType.INTEGER,
	                                                    mandatory=false) final Integer targetdice,
	                                         @Arguments(name="targetsides",description="Number of sides on dice",
	                                                    type=ArgumentType.INTEGER,
	                                                    mandatory=false) final Integer targetsides,
	                                         @Arguments(name="targetbias",description="Optional bias to add to result",
	                                                    mandatory=false,
	                                                    type=ArgumentType.INTEGER) final Integer targetbias,
	                                         @Nullable @Arguments(name="damage",description="Damage to apply to target if they lose",
	                                                              mandatory=false,
	                                                              type=ArgumentType.TEXT_ONELINE,
	...
	public static Response rollRolledDamageAgainst(@Nonnull final State st,
	                                               ...
	                                               @Arguments(name="targetbias",description="Optional bias to add to result",
	                                                          mandatory=false,
	                                                          type=ArgumentType.INTEGER) final Integer targetbias,
	                                               @Arguments(name="damagedice",description="Number of damage dice to roll",
	                                                          type=ArgumentType.INTEGER) final Integer damagedice,
	                                               @Arguments(name="damagesides",description="Number of sides on damage dice",
	                                                          type=ArgumentType.INTEGER) final Integer damagesides,
	                                               @Arguments(name="damagebias",description="Optional bias to add to damage result",
	                                                          mandatory=false,
