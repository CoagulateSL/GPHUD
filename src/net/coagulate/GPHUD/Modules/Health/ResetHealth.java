...
public class ResetHealth {
	...
	public static Response healRollChance(@Nonnull final State st,
	                                      ...
	                                      @Argument.Arguments(name="target",
	                                                          description="Target to heal",
	                                                          type=Argument.ArgumentType.CHARACTER_NEAR)
	                                      final Char target,
	                                      @Argument.Arguments(name="chancedice",
	                                                          description="Number of dice to roll for chance to heal",
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer chancedice,
	                                      @Argument.Arguments(name="chancesides",
	                                                          description="Sides on dice to roll for change to heal",
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer chancesides,
	                                      @Argument.Arguments(name="chancebias",
	                                                          description="Bias to add to ammount to chance to heal",
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer chancebias,
	                                      @Argument.Arguments(name="chancethreshold",
	                                                          description="Score to beat to succeed at healing",
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer chancethreshold,
	                                      @Argument.Arguments(name="healdice",
	                                                          description="Number of dice to roll for ammount healed",
	                                                          mandatory=false,
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer healdice,
	                                      @Argument.Arguments(name="healsides",
	                                                          description="Sides on dice to roll for ammount healed",
	                                                          mandatory=false,
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer healsides,
	                                      @Argument.Arguments(name="healbias",
	                                                          description="Bias to add to ammount to heal roll",
	                                                          mandatory=false,
	                                                          type=Argument.ArgumentType.INTEGER)
	                                      final Integer healbias,
	                                      @Argument.Arguments(name="reason",
	                                                          description="Reason for heal",
	...
	@Nonnull
	@Command.Commands(context=Command.Context.CHARACTER, description="Heal a target player", permitExternal=false)
	public static Response healRoll(@Nonnull final State st,
	                                ...
	                                @Nullable
	                                @Argument.Arguments(name="dice",
	                                                    description="Number of dice to roll",
	                                                    mandatory=false,
	                                                    type=Argument.ArgumentType.INTEGER) Integer dice,
	                                @Nullable
	                                @Argument.Arguments(name="sides",
	                                                    description="Sides on dice",
	                                                    mandatory=false,
	                                                    type=Argument.ArgumentType.INTEGER) Integer sides,
	                                @Nullable
	                                @Argument.Arguments(name="bias",
	                                                    description="Bias to roll",
	                                                    mandatory=false,
		...
		if (target==null) {
			throw new UserInputEmptyException("No target selected");
		}
		if (dice==null) {
