...
public class Damage {
	...
	public static void apply(@Nonnull final State st, @Nonnull final Char targetchar, final int damage, final String reason) {
	...
	public static void heal(@Nonnull final State st, @Nonnull final Char targetchar, final int healing, final String reason) {
		st.setTarget(targetchar);
		final int oldhealth = st.getTarget().getKV("Health.Health").intValue();
