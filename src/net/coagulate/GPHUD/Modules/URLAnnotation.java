    ...
    public void run(State st, SafeMap values) throws SystemException, UserException {
        try {
            method.invoke(null,new Object[]{st,values});
                ...
                if (contained instanceof NumberFormatException) { throw new UserException("Number Format Exception",contained); }
                if (contained instanceof NullPointerException) { throw new SystemException("Null Pointer Exception",contained); }
