...
@ModuleDefinition(defaultDisable=true, description="Events manager creates timed/locationed events, optionally awarding events xp", forceConfig=true, requires="Zoning",
