...
@Permissions(name="Create",
             description="Permission to create a brand new event",
...
@Permissions(name="Schedule",
             description="Ability to update the schedule for an event",
             power=Permission.POWER.LOW)
...
@Permissions(name="EventXP",
             description="Configure global settings related to event xp",
...
@Pools(name="EventXP",
       description="Experience earned through special events")

@SideMenu.SideMenus(name="Events",
                    priority=60,
                    url="/events")
