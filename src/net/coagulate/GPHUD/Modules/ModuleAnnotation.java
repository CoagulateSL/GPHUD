...
public class ModuleAnnotation extends Module {
    ...
    public KV getKVDefinition(State st, String qualifiedname) throws SystemException {
        ...
        if (!kvmap.containsKey(qualifiedname.toLowerCase())) { throw new SystemException("Invalid KV "+qualifiedname+" in module "+getName()); }
    ...
    public void validateCommand(State st, String command) throws SystemException {
        if (!commands.containsKey(command.toLowerCase())) { throw new SystemException("Command "+command+" does not exist in module "+getName()); }
    }
