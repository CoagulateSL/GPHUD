...
public class Input {
	...
	public static BCCharacter gsSelectCharacter(@Nonnull final State st, @Nonnull final GSVM vm, @Nonnull final BCCharacter target, @Nonnull final BCString message) {
	...
	public static BCString gsGetText(@Nonnull final State st, @Nonnull final GSVM vm, @Nonnull final BCCharacter target, @Nonnull final BCString message) {
	...
	public static BCString gsGetChoice(@Nonnull final State st, @Nonnull final GSVM vm, @Nonnull final BCCharacter target, @Nonnull final BCString message, @Nonnull final BCList choices) {
		if (vm.simulation) {
	...
	public static BCInteger gsIsANumber(final State st, final GSVM vm, @Nonnull final BCString teststring) {
		...
		catch (@Nonnull final GSCastException e) { return new BCInteger(null,0); }
