...
public class Input {
	...
	@Nonnull
	@GSFunctions.GSFunction(description="Triggers the character's HUD to select a nearby character", parameters="Character - target - The character to ask<br>String - "+
			"message - Description for the dialog box", notes="", returns="Character - a character the user selected", privileged=false)
	...
	@Nonnull
	@GSFunctions.GSFunction(description="Triggers the character's HUD to enter a string", parameters="Character - target - The character to ask<br>String - message - "+
			"Description for the dialog box", notes="", returns="String - Some user input text", privileged=false)
	...
	@Nonnull
	@GSFunctions.GSFunction(description="Triggers the character's HUD to offer a choice (menu box)", parameters="Character - target - The character to ask<br>String - "+
			"message - Description for the dialog box<br>List - A list of strings the user may choose from", notes="", returns="String - The user's selection", privileged=
			false)
	...
	@Nonnull
	@GSFunctions.GSFunction(description="Checks if a string can be converted into a number successfull", parameters="String - string to test", notes="", returns=
			"Integer - "+"1"+" if the string can convert to an integer, 0 if it fails to do so (and will crash your script if you try)", privileged=false)
