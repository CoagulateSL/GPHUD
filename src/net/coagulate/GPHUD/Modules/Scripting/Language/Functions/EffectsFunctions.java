...
public class EffectsFunctions {
	...
	@Nonnull
	public static BCList gsGetEffects(final State st,@Nonnull final GSVM vm,@Nonnull final BCCharacter target) {
	...
	@GSFunction(description="Gets the MetaData attached to a named effect",
	            ...
	            notes="",
	            category=SCRIPT_CATEGORY.EFFECTS)
	public static BCString gsGetEffectMetaData(final State st,@Nonnull final GSVM vm,@Nonnull final BCString effect) {
		net.coagulate.GPHUD.Modules.Scripting.Language.Functions.GSFunctions.assertModule(st,"Effects");
