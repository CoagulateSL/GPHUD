...
public class Character {
	...
	public static BCInteger gsGetAbilityPoints(@Nonnull final State state,final GSVM gsvm,final BCCharacter character) {
	...
	public static BCString gsGetPlayersName(@Nonnull final State state,final GSVM gsvm,final BCCharacter character) {
	...
	public static BCString gsGetPlayersUUID(@Nonnull final State state,final GSVM gsvm,final BCCharacter character) {
		final User currentPlayer=character.getContent().getPlayedByNullable();
	...
	public static BCCharacter gsGetCharacter(@Nonnull final State state,final GSVM gsvm,final BCString name) {
