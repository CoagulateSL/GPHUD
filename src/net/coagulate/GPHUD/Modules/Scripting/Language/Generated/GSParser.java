...
if (jjtc000) {
  ...
  final public void DiscardExpression() throws ParseException {/*@bgen(jjtree) DiscardExpression */
  GSDiscardExpression jjtn000 = new GSDiscardExpression(JJTDISCARDEXPRESSION);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
...
if (jjtc000) {
  ...
  final public void Return() throws ParseException {/*@bgen(jjtree) Return */
  GSReturn jjtn000 = new GSReturn(JJTRETURN);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));
    try {
  ...
  private boolean jj_3R_53()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7f9e8800,0x7f9c0000,0x28800,0x3f900000,0x28800,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x28800,0x28800,0x0,0x28800,0x0,0x0,0x28800,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x320448,0x40,0x320408,0x0,0x320408,0x1,0x0,0x4,0x2,0x1000,0x2000,0x4000,0x8000,0x10000,0x20000,0x40000,0x80000,0x320408,0x0,0x200000,0x320408,0x800000,0x800000,0x320408,};
   }
