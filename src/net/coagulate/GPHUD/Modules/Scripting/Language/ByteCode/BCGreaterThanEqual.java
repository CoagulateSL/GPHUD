...
public class BCGreaterThanEqual extends ByteCode {
	public BCGreaterThanEqual(final ParseNode n) {
		super(n);
	}
	                    ...
	                    final boolean simulation)
	{
		...
		throw new GSInternalError("Unable to calculate greater than or equal between types "+var1.getClass()
		                                                                                         .getSimpleName()+" and "+var2
				.getClass()
				.getSimpleName());
