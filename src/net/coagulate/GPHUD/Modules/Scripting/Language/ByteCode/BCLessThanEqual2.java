...
public class BCLessThanEqual2 extends ByteCode {
	public BCLessThanEqual2(final ParseNode n) {
		super(n);
	}
	...
	@Nonnull
	public String explain() { return "LessThanEqual2 (Pop two, compare, push 1 if 2nd pop less than or equal to top, else 0)"; }
