...
@Permission.Permissions(description="Allows the user to compile scripts that use privileged functions",name="CompilePrivileged",power=Permission.POWER.HIGH)
