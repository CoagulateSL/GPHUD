...
public class GenericXPPool extends Pool {
	...
	public void awardXP(@Nonnull final State st,
		...
		if (st.getCharacter().getLevel(st)>=maxLevel) { throw new UserInputStateException("This character is already at maximum level and can not be awarded any more experience of any type"); }
