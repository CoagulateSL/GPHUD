...
@Permissions(name = "ConfigureVisitXP", description = "Allowed to reconfigure the visitation XP settings")
@Permissions(name = "ConfigureLevels", description = "Allowed to reconfigure the leveling curve")
...
@KVS(name = "VisitXPDuration", defaultvalue = "60", editpermission = "Experience.ConfigureVisitXP", type = KVTYPE.INTEGER, scope = KVSCOPE.INSTANCE, description = "How long must be spent on the sim, total, to be awarded the Visit XP", template = false)
...
@KVS(name = "XPCycleDays", defaultvalue = "6.75", editpermission = "Experience.ConfigureXP", scope = KVSCOPE.INSTANCE, type = KVTYPE.FLOAT, description = "How long the XP cycle is (traditionally 1 week)", template = false)
