...
public class IntrospectionMenu {
	...
	public static void menu(State st, SafeMap values) throws UserException, SystemException {
		...
		f.p("Please see the documentation site at <a href=\"https://sl.coagulate.net/Docs/GPHUD/index.php/Main_Page.html\">https://sl.coagulate.net/Docs/GPHUD/index.php/Main_Page.html</a> for more.");
