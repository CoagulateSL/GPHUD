...
public class CharactersModule extends ModuleAnnotation {
	...
	public static int maxAbilityPoints(@Nonnull final State st) { return st.getKV("Experience.AbilityPoints").intValue(); }

	public static int abilityPointsRemaining(@Nonnull final State st) { return maxAbilityPoints(st) - spentAbilityPoints(st); }
	...
	public static Response spendAbilityPoint(@Nonnull final State st,
	                                         @Arguments(choiceMethod = "getRaisableAttributesList", description = "Attribute to spend an ability point on", type = Argument.ArgumentType.CHOICE) final
	                                         String attribute) {
	...
	public static Response set(@Nonnull final State st,
	                           @Nullable @Arguments(type = Argument.ArgumentType.ATTRIBUTE_WRITABLE, description = "Attribute to set") final
	                           Attribute attribute,
	                           @Arguments(type = Argument.ArgumentType.TEXT_ONELINE, description = "Value to use", mandatory = false, max = 4096) final
	                               String value) {
	...
	@Override
	public void addTemplateDescriptions(@Nonnull final State st, @Nonnull final Map<String, String> addto) {
	...
	@Override
	public void addTemplateMethods(@Nonnull final State st, @Nonnull final Map<String, Method> addto) {
		final Map<String, KV> ourmap = getKVDefinitions(st);
		for (final Attribute attr : st.getAttributes()) {
			try {
