...
public abstract class Pool extends NameComparable {
	...
	public int entries(final State st,final Char ch) {
		if (ch.getInstance()!=st.getInstance()) {
			throw new SystemConsistencyException("Pool entries character instance/state instance mismatch");
		}
	 ...
	 */
	public void addChar(final State st,final Char target,final int ammount,final String description) {
		CharacterPool.addPool(st,target,this,ammount,description);
	}
	
	public void addAdmin(final State st,final Char target,final int ammount,final String description) {
		CharacterPool.addPoolAdmin(st,target,this,ammount,description);
	}
	
	public void addSystem(final State st,final Char target,final int ammount,final String description) {
