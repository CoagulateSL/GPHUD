...
@Permission.Permissions(description = "Can configure publishing details",name = "Config")
@KV.KVS(name = "PublishGroups",defaultvalue = "false",description = "Publish group memberships",editpermission = "Publishing.Config",scope = KV.KVSCOPE.INSTANCE,template = false,type = KV.KVTYPE.BOOLEAN)
