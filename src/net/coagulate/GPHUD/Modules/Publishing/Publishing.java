...
public class Publishing {
	...
	static void contentResizer(State st) {st.form.add("<script type=\"text/javascript\" src=\"https://coagulate.sl/resources/iframeResizer.contentWindow.min.js\"></script>");}
