...
@Permissions(description="Permission to delete a menu", name="Delete", power=POWER.MEDIUM)
...
@Change(component=COMPONENT.Core,
        type=CHANGETYPE.Fix,
        date="2022-04-23",
        message="Menu descriptions are now conveyed to the HUD and displayed, also editable.  Note that main menu description support requires a HUD upgrade") @Change(
		component=COMPONENT.Protocol,
		type=CHANGETYPE.Add,
		date="2022-04-23",
		message="HUD Protocol version 5 expects the mainmenu payload to be prefixed with a description.")
