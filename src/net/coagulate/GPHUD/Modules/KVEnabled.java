...
public class KVEnabled extends KV {
    ...
    Module module;
    String def;
    public KVEnabled(Module m,String def) { this.module=m; this.def=def; } // technically is generated, but generated really means "instance specific", and these KVs aren't, they're just a convenience for writing the static declaration.
