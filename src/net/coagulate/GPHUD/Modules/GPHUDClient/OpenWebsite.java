...
public class OpenWebsite {
	...
	@Commands(context = Context.CHARACTER, description = "Causes the GPHUD to send an llOpenURL to the user directing them to SSO to the Main Website", permitUserWeb = false, permitHUDWeb = false)
