...
public class LEDInfo {
	...
	@Nonnull
	@Commands(context=Command.Context.ANY, description="Gives information about the RED / TRANSMIT light", permitScripting=false, permitObject=false, permitConsole=false, permitUserWeb=false, permitJSON=false)
	...
	@Nonnull
	@Commands(context=Command.Context.ANY, description="Gives information about the GREEN / RECEIVE light", permitScripting=false, permitObject=false, permitConsole=false, permitUserWeb=false, permitJSON=false)
	public static Response rx(final State st) {
		return new OKResponse(
				"The green light is the RECEIVE light.\nDARK GREEN - Receiver has been set up and registered, and is idle.\nBRIGHT GREEN - A message is being received\nBLACK - No receiving circuit has been created, or it failed.");
	}
}
