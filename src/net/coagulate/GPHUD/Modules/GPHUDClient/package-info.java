...
@Permissions(name="config", description="Ability to configure the GPHUD interface", power=Permission.POWER.MEDIUM) @Permissions(name="EditHUDText",
...
@KVS(name="widthmultiplier",
     ...
     template=false,
     conveyas="sizeratio") @KVS(name="logo",
                                ...
                                conveyas="setlogo",
                                hierarchy=KVHIERARCHY.DELEGATING,
                                template=false) @KVS(name="quickbutton1",
                                                     ...
                                                     type=KVTYPE.COMMAND,
                                                     hierarchy=KVHIERARCHY.DELEGATING,
                                                     template=false) @KVS(name="quickbutton2",
                                                                          ...
                                                                          type=KVTYPE.COMMAND,
                                                                          hierarchy=KVHIERARCHY.DELEGATING,
                                                                          template=false) @KVS(name="quickbutton3",
                                                                                               ...
                                                                                               type=KVTYPE.COMMAND,
                                                                                               hierarchy=KVHIERARCHY.DELEGATING,
                                                                                               template=false) @KVS(name="quickbutton4",
                                                                                                                    ...
                                                                                                                    type=KVTYPE.COMMAND,
                                                                                                                    hierarchy=KVHIERARCHY.DELEGATING,
                                                                                                                    template=false) @KVS(name="quickbutton5",
                                                                                                                                         ...
                                                                                                                                         type=KVTYPE.COMMAND,
                                                                                                                                         hierarchy=KVHIERARCHY.DELEGATING,
                                                                                                                                         template=false) @KVS(name="quickbutton6",
		...
		conveyas="qb1texture",
		hierarchy=KVHIERARCHY.DELEGATING,
		template=false) @KVS(name="quickbutton2texture",
                             ...
                             conveyas="qb2texture",
                             hierarchy=KVHIERARCHY.DELEGATING,
                             template=false) @KVS(name="quickbutton3texture",
                                                  ...
                                                  conveyas="qb3texture",
                                                  hierarchy=KVHIERARCHY.DELEGATING,
                                                  template=false) @KVS(name="quickbutton4texture",
                                                                       ...
                                                                       conveyas="qb4texture",
                                                                       hierarchy=KVHIERARCHY.DELEGATING,
                                                                       template=false) @KVS(name="quickbutton5texture",
                                                                                            ...
                                                                                            conveyas="qb5texture",
                                                                                            hierarchy=KVHIERARCHY.DELEGATING,
                                                                                            template=false) @KVS(name="quickbutton6texture",
                                                                                                                 ...
                                                                                                                 conveyas="qb6texture",
                                                                                                                 hierarchy=KVHIERARCHY.DELEGATING,
                                                                                                                 template=false) @KVS(name="HudText",
                                                                                                                                      defaultvalue="--NAME--",
                                                                                                                                      ...
                                                                                                                                      hierarchy=KVHIERARCHY.DELEGATING,
                                                                                                                                      template=true,
                                                                                                                                      conveyas="hudtext") @KVS(name="HudTextColor",
		...
		hierarchy=KVHIERARCHY.DELEGATING,
		template=true,
		conveyas="titlertext") @KVS(name="TitlerColor",
                                    ...
                                    hierarchy=KVHIERARCHY.DELEGATING,
                                    template=true,
                                    conveyas="titlercolor") @KVS(name="RpChannel",
                                                                 defaultvalue="2",
                                                                 conveyas="rpchannel",
                                                                 ...
                                                                 template=true,
                                                                 type=KVTYPE.INTEGER,
                                                                 editpermission="GPHUDClient.Config") @KVS(name="Name",
                                                                                                           defaultvalue="--NAME--",
                                                                                                           ...
                                                                                                           template=true,
                                                                                                           type=KVTYPE.TEXT) @KVS(name="TitlerAltitude",
                                                                                                                                  defaultvalue="0.19",
                                                                                                                                  conveyas="titlerz",
